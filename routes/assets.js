...
router
    ...
    .get('/:accountId/:assetId', (req, res, next) => {
        return res.json(_.find(mockData, { id: req.params.assetId, account_id: parseInt(req.params.accountId) }));
    })
    ...
    .patch('/:accountId/:assetId', (req, res, next) => {
        ...
        let data = _.find(mockData, { id: req.params.assetId, account_id: parseInt(req.params.accountId) });
        if (data) {
