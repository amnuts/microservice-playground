...
router
    ...
    .get('/:accountId/:userId', (req, res, next) => {
        return res.json(_.find(mockData, { id: parseInt(req.params.userId), account_id: parseInt(req.params.accountId) }));
    })
    ...
    .patch('/:accountId/:userId', (req, res, next) => {
        ...
        let data = _.find(mockData, { id: parseInt(req.params.userId), account_id: parseInt(req.params.accountId) });
        if (data) {
